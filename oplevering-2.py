...
tm_unknown.read_text_from_file('mostly_harmless.txt') # another.txt :6e hitchhikersboek geschreven door Colfer / mostly_harmless.txt : Douglas Adams 5e HHGTG boek
